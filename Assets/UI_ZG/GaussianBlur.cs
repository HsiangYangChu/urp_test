...
[ExecuteInEditMode]
[AddComponentMenu("Custom/GaussShader")]
public class GaussianBlur : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SCShader = Shader.Find("Custom/GaussShader");
    ...
    {
        Debug.Log("djkasjkfjsladsjlfjlfjklsjfjdkljfkdjlkscnnds,jfhkh");
        if (SCShader != null)
        {
    ...
    void Update()
    {
        // Debug.Log("update: djkasjkfjsladsjlfjlfjklsjfjdkljfkdjlkscnnds,jfhkh");
