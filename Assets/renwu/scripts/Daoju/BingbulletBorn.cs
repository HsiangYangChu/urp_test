...
public class BingbulletBorn : MonoBehaviour
{
    ...
    public static float bornTime = 5f;

    public static bool flagbing = false;
    ...
    {
        CancelInvoke("Born");
        Debug.Log("bing is born!!!!!!!!!");
        nav.isStopped = true;
        Vector3 ve = new Vector3(transform.position.x, transform.position.y + 1.27f, transform.position.z);
