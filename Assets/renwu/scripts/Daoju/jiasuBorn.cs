...
public class jiasuBorn : MonoBehaviour
{
    //随机生成道具
    ...
    public static float bornTime = 40f;

    public static bool flagspeed = false;
    ...
    void Born()
    {
        CancelInvoke("Born");
        nav.isStopped = true;
        Vector3 ve = new Vector3(transform.position.x, transform.position.y + 1.2f, transform.position.z);
